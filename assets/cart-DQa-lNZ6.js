import{g as p,s as l}from"./utils-DCJhy6CD.js";/* empty css                   */function i(){const t=p("so-cart")||[],e=document.querySelector(".product-list"),c=document.querySelector(".cart-sum"),n=document.querySelector(".cart-total");if(t.length===0){e.innerHTML="<p>Your cart is empty.</p>",c.classList.add("hide");return}const a=m(t),r=a.map(f);e.innerHTML=r.join("");const o=v(a);n.textContent=`Total: $${o.toFixed(2)}`,c.classList.remove("hide"),y(t)}function m(t){const e={};return t.forEach(c=>{const n=c.Id;e[n]?e[n].Quantity+=1:e[n]={...c,Quantity:1}}),Object.values(e)}function f(t){return`
